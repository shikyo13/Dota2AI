...
This folder is the Tier 3L source data library for the current Dota2AI bot script. It stores generated ledgers so higher-level docs can stay short and route readers to exact source slices.

|Document|Use|
|-|-|
|[source-coverage.md](source-coverage.md)|Coverage summary, file counts, line counts, largest source files.|
|[module-inventory.md](module-inventory.md)|Full tracked non-third-party file inventory.|
