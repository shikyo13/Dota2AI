...
Current worktree branch: `codex/oha-improvements-20260501`.
...
The source ledger covers tracked repository files outside `.git`, `.worktrees`, `node_modules`, and generated `docs/data`.
